...
ALGORITHM_CONFIGS = {
    ...
    "dilithium2": {
        "name": "Dilithium2",
        "root_algo": "Dilithium5",
        "intermediate_algo": "Dilithium3",
        "server_algo": "Dilithium2",
    ...
    "dilithium3": {
        ...
        "root_algo": "Dilithium5",
        "intermediate_algo": "Dilithium3",
        "server_algo": "Dilithium3",
        "description": "Dilithium (实验版本)"
    },
}


def generate_certificate_chain(algo_key: str, base_dir: str = "enhanced_certificates"):
    """
    生成指定算法的完整证书链
...
def generate_all_algorithms():
    ...
    # 生成总索引
    with open("enhanced_certificates/all_certs_index.json", 'w') as f:
    ...
    print(f"\n索引文件: enhanced_certificates/all_certs_index.json")

...
class CertificateLoader:
    ...
    def extract_pq_algorithm_from_cert(cert: x509.Certificate) -> Optional[str]:
        ...
        try:
            from implementation.enhanced_v2.pq_certificates.x509_wrapper import PQ_ALGORITHM_OID
...
def load_server_certificates(mode: str = 'HYBRID') -> ServerCertificateBundle:
    """加载服务器证书包"""
    from implementation.enhanced_v2.config import get_default_cert_paths
